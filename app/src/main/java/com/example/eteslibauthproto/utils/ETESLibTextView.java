...
public class ETESLibTextView extends androidx.appcompat.widget.AppCompatTextView {

    private TypeFactory mFontFactory;

    public ETESLibTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context, attrs);
    }

    public ETESLibTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        applyCustomFont(context, attrs);
    }

    public ETESLibTextView(Context context) {
        super(context);
    }
