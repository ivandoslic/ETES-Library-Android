...
public class ETESLibCheckBox extends MaterialCheckBox {
    private TypeFactory mFontFactory;

    public ETESLibCheckBox(Context context) {
        super(context);
    }

    public ETESLibCheckBox(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context, attrs);
    }

    public ETESLibCheckBox(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
