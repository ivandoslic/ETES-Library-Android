...
public class ETESLibEditText extends TextInputEditText {

    private TypeFactory mFontFactory;

    public ETESLibEditText(@NonNull Context context) {
        super(context);
    }

    public ETESLibEditText(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context, attrs);
    }

    public ETESLibEditText(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
